...
//       { text: "No" },
//       { text: "Yes", onPress: async () => { setStartDate(null); }}
//     ]);
//   };
...
//         theme={{ calendarBackground: '#000', dayTextColor: '#fff', monthTextColor: '#10b981', todayTextColor: '#10b981' }}
//       />
