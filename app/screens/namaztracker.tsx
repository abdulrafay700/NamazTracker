...
//     const startSpin = () => {
//       gearAnim.setValue(0);
//       Animated.timing(gearAnim, { toValue: 1, duration: 2000, easing: Easing.linear, useNativeDriver: true }).start(() => startSpin());
//     };
//     startSpin();
//   }, []);
...
//         fetchPrayerTimes(); 
//     } 
//   }, [selectedDate, sect, startDate, location]);
...
//     setShowToast(true);
//     Animated.parallel([
//       Animated.timing(toastOpacity, { toValue: 1, duration: 400, useNativeDriver: false }),
//       Animated.timing(toastTranslateY, { toValue: 0, duration: 400, useNativeDriver: false }),
//     ]).start();

//     setTimeout(() => {
//       Animated.parallel([
//         Animated.timing(toastOpacity, { toValue: 0, duration: 400, useNativeDriver: false }),
//         Animated.timing(toastTranslateY, { toValue: -20, duration: 400, useNativeDriver: false }),
...
//               ? '#059669' // Green if all done
//               : isToday 
//                 ? '#6366f1' // Indigo if today and not all done
//                 : count > 0 ? '#d97706' : '#dc2626', // Orange or Red for others
//             borderRadius: 8, 
...
//             <Text style={styles.toastText}>Cloud Synced Successfully</Text>
//           </View>
//         </Animated.View>
//       )}
...
//             </TouchableOpacity>
//           </View>
//           <Calendar markingType="custom" markedDates={markedDates} minDate={startDate || undefined} maxDate={todayStr} onDayPress={(day) => setSelectedDate(day.dateString)} theme={{ calendarBackground: 'transparent', dayTextColor: '#fff', monthTextColor: '#10b981', todayTextColor: '#10b981', arrowColor: '#10b981', textDisabledColor: 'rgba(255, 255, 255, 0.1)' }} />
//         </View>
...
//   headerDateText: { color: '#fff', fontSize: 16, marginTop: 2 },
//   headerIslamicText: { color: '#10b981', fontSize: 14, fontWeight: '600', marginTop: 2 },
//   sectBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0a0a0a', paddingHorizontal: 12, borderRadius: 12, height: 35, gap: 6, borderWidth: 1.5, borderColor: '#10b981' },
//   sectBtnText: { color: '#10b981', fontWeight: 'bold', fontSize: 11 },
//   statsContainer: { flexDirection: 'row', gap: 12, marginBottom: 20 },
//   statCard: { flex: 1, backgroundColor: '#0a0a0a', padding: 15, borderRadius: 20, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.05)' },
//   statNum: { fontSize: 24, fontWeight: 'bold' },
...
//   calendarCardTitle: { color: '#444', fontSize: 10, fontWeight: 'bold', textTransform: 'uppercase' },
//   gearWrapper: { padding: 5 },
//   glowBox: { width: 38, height: 38, borderRadius: 12, backgroundColor: '#0a0a0a', justifyContent: 'center', alignItems: 'center', borderWidth: 1.5, borderColor: '#10b981' },
//   detailContainer: { padding: 20, backgroundColor: '#050505', borderRadius: 25, borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', minHeight: 350 },
//   detailHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
//   detailHeader: { color: '#fff', fontSize: 15, fontWeight: 'bold' },
//   dateLabel: { color: '#10b981', fontSize: 15, fontWeight: 'bold' },
